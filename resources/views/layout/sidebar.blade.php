<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="/{{auth()->user()->level}}/dashboard" class="nav-link"><i class="fa fa-desktop fa-lg"></i><span>Dashboard</span></a>
            </li>
            ...
            <li class="dropdown">
                <a href="/{{auth()->user()->level}}/barang" class="nav-link"><i class="fa fa-cubes"></i><span>Barang</span></a>
            </li>
            @endif
            ...
            <li class="dropdown">
                <a href="/{{auth()->user()->level}}/laporan" class="nav-link"><i class="fa fa-file"></i><span>Laporan</span></a>
            </li>
            @endif
            @if(auth()->user()->level == 'admin')
            <li class="dropdown">
